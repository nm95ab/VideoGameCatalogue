...
Write-Host "  ✔ .NET SDK found: $dotnetVer" -ForegroundColor Green
...
Write-Host "`n[3/5] Verifying Dependencies..." -ForegroundColor White
...
Write-Host "`n[4/5] Compiling Solution..." -ForegroundColor White
...
Write-Host "`n[5/5] Launching Services..." -ForegroundColor White
...
try {
    Write-Host "`n  Waiting for services to become responsive..."
    for ($i = 1; $i -le 30; $i++) {
        try {
